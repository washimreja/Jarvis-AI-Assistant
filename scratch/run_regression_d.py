...
base_dir = pathlib.Path(r"D:\washim_project_2\Jarvis-AI-Assistant")
...
def test_action_loader():
    print("\n--- Test Suite 1: Action Loader Discovery on D: ---")
...
def test_conversation_context():
    print("\n--- Test Suite 2: Recent Conversation Context on D: ---")
...
def test_ai_news():
    print("\n--- Test Suite 3: AI News Aggregator & Briefing on D: ---")
...
def test_browser_and_window():
    print("\n--- Test Suite 4: Browser Control & Window Control on D: ---")
    # Navigate
...
def main():
    print("========================================================")
    print("   JARVIS D: WORKSPACE COMPREHENSIVE REGRESSION SUITE   ")
    print("========================================================")
    ...
    print("\n========================================================")
    print("   ALL TEST SUITES ON D: COMPLETED: 100% PASS          ")
    print("========================================================")
